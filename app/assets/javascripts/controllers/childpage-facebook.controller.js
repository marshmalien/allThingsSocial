angular.module('app').controller('childpageController', function() {
  this.instructionSteps = [
    {name: 'stepOne', arrow: 'left', description: "This is where you can write message for all of your daughter's friends to see. Please keep the short and sweet!"},
    {name: 'stepTwo', arrow: 'left', description: 'This is where you will send 99% of your messages to your daughter.'},
    {name: 'stepThree', arrow: 'right', description: "You probably don't need to suggest friends for your daughter."},
